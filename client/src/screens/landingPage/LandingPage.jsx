...
import {Box, Typography, Autocomplete, Card, Rating, Grid} from "@mui/material"
  ...
  return (
    <Box className = {classes.outerContainer}>
      <Box className ={classes.topContainer}>
        <SearchBar options = {cities} propClass = {classes.searchBarPos}></SearchBar>
      </Box>
      <Box className = {classes.bottomContainer}>
        <Box className = {classes.infoBox}>
          ...
          <Box className = {classes.textIconBox}>
            <ComputerIcon className = {classes.icon} fontSize = "large"></ComputerIcon>
            <Typography variant = "subtitle1" sx = {{marginLeft: "2vw"}}>Read Reviews left by people who have been to a study place with the same intentions as you.</Typography>
          </Box>
        </Box>
          <Box className = {classes.textIconBox}>
            <MarkUnreadChatAltIcon fontSize = "large"></MarkUnreadChatAltIcon>
            <Typography variant = "subtitle1" sx = {{marginLeft: "2vw"}}>Leave reviews to help others find the perfect place to study/work!</Typography>
          </Box>
        </Box>
        <Card className = {classes.card}>
          <Typography variant = "h4"sx = {{marginTop: "2vh"}}>What can you rate by?</Typography>
          <Box className = {classes.textIconBox}>
          ...
          <Typography sx = {{marginTop: "4vh"}}variant = "h4">And many more metrics!</Typography>
        </Card>

      </Box>
      <Box className = {classes.lastContainer}>
        <Typography variant = "h4">Search study locations in popular cities!</Typography>
